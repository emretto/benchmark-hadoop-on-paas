...
HIBENCH_REPORT = sprintf("%s%s%s", "report.", BNCH, ".dat")
...
plot GCP_W0_CPU_ALL u 1:3 w l lc rgb LC_CPU_W0 t "w0-cpu%" axes x1y1, \
	GCP_W1_CPU_ALL u 1:3 w l lc rgb LC_CPU_W1 t "w1-cpu%" axes x1y1, \
	GCP_W2_CPU_ALL u 1:3 w l lc rgb LC_CPU_W2 t "w2-cpu%" axes x1y1, \
...
plot AZU_W0_CPU_ALL u 1:3 w l lc rgb LC_CPU_W0 t "w0-cpu%" axes x1y1, \
...
plot ALI_W0_CPU_ALL u 1:3 w l lc rgb LC_CPU_W0 t "w0-cpu%" axes x1y1, \
	...
	ALI_W0_RAM u 1:5 w l lc rgb LC_RAM_W0 t "w0-mem%" axes x1y1, \
	ALI_W1_RAM u 1:5 w l lc rgb LC_RAM_W1 t "w1-mem%" axes x1y1, \
	ALI_W2_RAM u 1:5 w l lc rgb LC_RAM_W2 t "w2-mem%" axes x1y1, \
