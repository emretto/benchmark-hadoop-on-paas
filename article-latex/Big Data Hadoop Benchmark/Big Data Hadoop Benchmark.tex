...
\paragraph{HDFS}Hadoop's native file system is inherited from the principles guidelined in a whitepaper in 2003 \cite{ghemawat_google_2003} and leveraged to store Petabyte scale data in production environment. Figure \ref{fig:HDFSoverview} depicts the main architecture enabling distributed file system among a cluster.
