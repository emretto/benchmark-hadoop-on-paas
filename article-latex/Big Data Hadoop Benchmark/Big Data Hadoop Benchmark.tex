...
\begin{frontmatter}
	...
	\begin{abstract}
		...
		The global Cloud Service Providers have recently focused  service-oriented and pre-configured big data %analytical cloud
		solutions to automate server management and scaling. This lead to development of managed systems service, in which %the contractor overtakes 
...
%\paragraph{Hadoop \cite{noauthor_apache_nodate}}
...
%\paragraph{Alibaba Cloud e-MapReduce \cite{noauthor_what_nodate}}
...
%\paragraph{HiBench \cite{noauthor_intel-bigdatahibench_2021}}
...
%\subsection{Use Case 1 Overview}
...
%\paragraph{Sort - Huge (Figure \ref{fig:uc1-srt-h-cmidt})}
\subsection{Sort Benchmark Results}
%\subsubsection{Sort - Huge}
...
%\subsubsection{Sort - Gigantic}
%\paragraph{Sort - Gigantic (Figure \ref{fig:uc1-srt-g-cmidt})}
...
%\paragraph{Terasort - Huge (Figure \ref{fig:uc1-tera-h-cmidt})}
\subsection{Terasort}
...
%\paragraph{Terasort - Gigantic (Figure \ref{fig:uc1-tera-g-cmidt})}
...
%\paragraph{Wordcount - Huge (Figure \ref{fig:uc1-wrdcnt-h-cmidt})}
...
%\paragraph{Wordcount - Gigantic (Figure \ref{fig:uc1-wrdcnt-g-cmidt})}
...
%\paragraph{Dfsioe-read - Huge (Figure \ref{fig:uc1-dfsioer-h-cmidt})}
...
%\paragraph{Overviews of Sort and Wordcount utilizations along with data scales Tiny, Small, Large, Huge, and Gigantic (Figure \ref{fig:uc2-srt-new} and Figure \ref{fig:uc2-wrdcnt-new})}
...
% Tiny, Small, Large, Huge, Gigantic (Figures \ref{fig:uc2-wrdcnt-t-cmidt}, \ref{fig:uc2-wrdcnt-s-cmidt}, \ref{fig:uc2-wrdcnt-l-cmidt}, \ref{fig:uc2-wrdcnt-h-cmidt}, \ref{fig:uc2-wrdcnt-g-cmidt})
...
\section{Discussion}
%\paragraph{Limitations, workarounds, failures}
