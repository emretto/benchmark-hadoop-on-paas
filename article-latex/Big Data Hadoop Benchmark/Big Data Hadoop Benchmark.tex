...
The Sort benchmark is mainly IO-bound, and the Wordcount benchmark is mainly CPU-bound. In this section, for each provider's service, we inspect utilization behavior of IO transfers per second for Sort, and a CPU utilization behavior for Wordcount.

\paragraph{Sort - Tiny, Small, Large, Huge, Gigantic (Figures \ref{fig:uc2-srt-t-cmidt}, \ref{fig:uc2-srt-s-cmidt}, \ref{fig:uc2-srt-l-cmidt}, \ref{fig:uc2-srt-h-cmidt}, \ref{fig:uc2-srt-g-cmidt})} In the data scales tiny and small, Alibaba Cloud's e-MapReduce 
